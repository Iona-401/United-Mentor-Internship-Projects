...
class LiverCirrhosisApp(QWidget):
    def __init__(self):
        ...
        try:
            self.model = joblib.load(
                os.path.join(base_dir, "random_forest_liver_cirrhosis_model.pkl")
            )
    ...
    def init_ui(self):
        ...
        # Form fields
        self.add_input_field("N_Days", "Number of Days since Registration")
        ...
        self.add_combo_field("Drug", "Drug", {"D-Penicillamine": 1, "Placebo": 0})
        self.add_combo_field("Sex", "Gender", {"Male": 1, "Female": 0})
        self.add_combo_field("Ascites", "Ascites", {"Yes": 1, "No": 0})
        self.add_combo_field("Hepatomegaly", "Hepatomegaly", {"Yes": 1, "No": 0})
        self.add_combo_field("Spiders", "Spiders", {"Yes": 1, "No": 0})
        self.add_combo_field(
            "Edema",
            "Edema",
        ...
        form_section.addRow(
            QLabel("Triglycerides Level:"), self.fields["Tryglicerides"]
        )
